...
public class Decoder extends ByteToMessageCodec<Object>{

    //自定义解码器

    @Override
    protected void encode(ChannelHandlerContext channelHandlerContext, Object o, ByteBuf in) throws Exception {
//        new Encoder().encode(channelHandlerContext,o,byteBuf);
        String a = "22";
    }
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        byte[] body = new byte[dataLength];  // 这时，我们读到的长度，满足我们的要求，把传送过来的数据取出
        in.readBytes(body);
        //将byte数据转化为我们需要的对象。
        String jsonString = JSONUtils.toJSONString(body);
        Object parse = JSONUtils.parse(jsonString);
